...
```
As the US has the largest number of wines, I wanted to see how the distribution looked between red and white wines, as well as see the the distribution of US wines based on price vs points. I found that Pinot Noir was the most common red variety with almost 10,000 observations. Following Pinot Noir is Cabernet Sauvignon with just under 7,500 different wines. The hex plot shows that the highest density of US wines are between $1-$125 and score around 90 points.
